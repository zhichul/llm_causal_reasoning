...
train_file="['data/ppo/${graph_spec}/${train_size}/no_graph_shuffle/seed_42/d0/train.parquet', 'data/ppo/${graph_spec}/${train_size}/no_graph_shuffle/seed_42/d1/train.parquet', 'data/ppo/${graph_spec}/${train_size}/no_graph_shuffle/seed_42/d2/train.parquet', 'data/ppo/${graph_spec}/${train_size}/no_graph_shuffle/seed_42/d3/train.parquet', 'data/ppo/${graph_spec}/${train_size}/no_graph_shuffle/seed_42/d4/train.parquet']"
val_file=data/ppo/${graph_spec}/2k/no_graph_shuffle/dev.parquet
echo $train_file
