...
while [[ "$#" -gt 0 ]]; do
    case "$1" in
        ...
        --help|-h)
            ...
            echo "  --graph_spec <str> --eval_freq <int> --train_size <str> --lora_rank <int>"
            exit 0
            ;;
...
experiment_name="exp_${graph_spec}_model_${model_name}_bs${batch_size}_lr${lr}_len${max_length}_ts${train_size}_lora${lora_rank}"
...
val_file="['data/ppo/${graph_spec}/2k/d0/dev.parquet', 'data/ppo/${graph_spec}/2k/d1/dev.parquet', 'data/ppo/${graph_spec}/2k/d2/dev.parquet', 'data/ppo/${graph_spec}/2k/d3/dev.parquet', 'data/ppo/${graph_spec}/2k/d4/dev.parquet', 'data/ppo/${graph_spec}/2k/d5/dev.parquet']"
