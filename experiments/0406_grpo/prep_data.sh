...
do
data_source=../../data/2025-06-16/interventional_distribution
...
python3 prepare_ppo_data.py \
    ...
    --data_source $data_source \
    --data_subsplits ${graph_spec} \
    --local_dir data/ppo/${graph_spec}/2k/ \
    --data_name ${data_name} \
    --seed ${seed}
...
python3 prepare_ppo_data.py \
    ...
    --filter_key ancestor_depth \
    --filter_val ${i} \
    --local_dir data/ppo/${graph_spec}/2k/d${i} \
    --data_name ${data_name} \
    --seed ${seed}
done
...
python3 prepare_ppo_data.py \
    ...
    --data_source $data_source \
    --data_subsplits ${graph_spec} \
    --local_dir data/ppo/${graph_spec}/4k/ \
    --data_name ${data_name} \
    --seed ${seed}
...
python3 prepare_ppo_data.py \
    ...
    --filter_key ancestor_depth \
    --filter_val ${i} \
    --local_dir data/ppo/${graph_spec}/4k/d${i} \
    --data_name ${data_name} \
    --seed ${seed}
done
...
python3 prepare_ppo_data.py \
    ...
    --data_source $data_source \
    --data_subsplits ${graph_spec} \
    --local_dir data/ppo/${graph_spec}/8k/ \
    --data_name ${data_name} \
    --seed ${seed}
...
python3 prepare_ppo_data.py \
    ...
    --filter_key ancestor_depth \
    --filter_val ${i} \
    --local_dir data/ppo/${graph_spec}/8k/d${i} \
    --data_name ${data_name} \
    --seed ${seed}
done
...
python3 prepare_ppo_data.py \
    ...
    --data_source $data_source \
    --data_subsplits ${graph_spec} \
    --local_dir data/ppo/${graph_spec}/16k/ \
    --data_name ${data_name} \
    --seed ${seed}
...
python3 prepare_ppo_data.py \
    ...
    --filter_key ancestor_depth \
    --filter_val ${i} \
    --local_dir data/ppo/${graph_spec}/16k/d${i} \
    --data_name ${data_name} \
    --seed ${seed}
done
done