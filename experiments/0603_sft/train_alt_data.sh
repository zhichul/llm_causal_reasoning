...
while [[ "$#" -gt 0 ]]; do
    case "$1" in
        ...
        --help|-h)
            ...
            echo "  --graph_spec <str> --eval_freq <int> --train_size <str> --lora_rank <int> --data_source <str>"
            exit 0
            ;;
...
experiment_name="exp_alt_${graph_spec}_model_${model_name}_bs${batch_size}_lr${lr}_len${max_length}_ts${train_size}_lora${lora_rank}"
