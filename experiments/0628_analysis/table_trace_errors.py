...
folder = 'tables/trace_errors/'
os.makedirs(folder, exist_ok=True)
d = load_yaml('configs/table_trace_errors.yaml')
...
make_latex_table(column_names, row_names, columns_values, keeps, f'tables/trace_errors/table.tex')
