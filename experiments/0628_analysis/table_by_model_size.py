...
for model_size in ["7b", "32b"]:
    folder = f'tables/{model_size}/'
    os.makedirs(folder, exist_ok=True)
    d = load_yaml(f'configs/table_{model_size}.yaml')
    ...
    for breakdown_key in d['breakdowns']:
        ...
        for kwargs_perf in kwargs_perfs:
            ...
            make_latex_table(column_names, row_names, columns_values, keeps, f'tables/{model_size}/table_by_{breakdown["name"]}_at_{kwargs_perf["t"]:.2f}.tex')
