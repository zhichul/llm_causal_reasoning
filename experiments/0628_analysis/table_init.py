...
d = load_yaml('configs/table_init.yaml')
...
for breakdown_key in d['breakdowns']:
    ...
    for kwargs_perf in kwargs_perfs:
        ...
        make_latex_table(column_names, row_names, columns_values, keeps, f'tables/init/table_by_{breakdown["name"]}_at_{kwargs_perf["t"]:.2f}.tex')
